        ...
        <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
            ...
            <div className='flex items-center'>
                ...
                <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>
                    Yammy <span className='font-bold'>Food</span>
                </h1>
            ...
            <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px] '>
                ...
                <input className='bg-tranparent p-2 w-full focus:outline-none' type='text' placeholder='Search foods' />
            </div>
            {/*cart button */}
            ...
            'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300' }>
                ...
                <h2 className='text-2xl p-4'>Yammy <span className='font-bold'>Food</span></h2>
                <nav>
